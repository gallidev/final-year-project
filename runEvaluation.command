#! /bin/bash
python3 model_test_accuracy.py --model_path model/1_model/1_model_26e_128_quantized.tflite --tflite 
...
python3 model_test_accuracy.py --model_path model/1_model/1_model_26e_128.pb --no_tflite
